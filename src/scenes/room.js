...
export default class Room extends Phaser.Scene {
    ...
    create() {
        ...
        let haveGUI = this.scene.launch('gui', {life: this.player.actualLife, maxLife: this.player.maxLife, mana: this.player.actualMana, maxMana:  this.player.maxMana,keys: this.player.key});
