...
export default class MainMenu extends Phaser.Scene {
    ...
    create() {
        ...
        this.playButton.on("pointerup", () => {
            ...
            // this.scene.start('grR8',{ dg:dungeonGenerator.init(),X: dungeonGenerator.getEntranceX(), Y: dungeonGenerator.getEntranceY(),dir:'w', SSM: dungeonGenerator.generateSaveStateMatrix(dungeonGenerator.getN(),dungeonGenerator.getM()),playerStat:null,jukebox: this.jukebox});
        })
