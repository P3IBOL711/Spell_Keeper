...
export default class MainMenu extends Phaser.Scene {
    ...
    create() {
        ...
        this.playButton.on("pointerup", () => {
           ...
           this.scene.start('grX1',{ dg:dungeonGenerator.init(),X: dungeonGenerator.getEntranceX(), Y: dungeonGenerator.getEntranceY(),dir:'s', SSM: dungeonGenerator.generateSaveStateMatrix(dungeonGenerator.getN(),dungeonGenerator.getM()),playerStat:null,jukebox: this.jukebox});
        })
